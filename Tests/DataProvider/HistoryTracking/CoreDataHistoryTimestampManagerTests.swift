...
final class CoreDataHistoryTimestampManagerTests: XCTestCase {
    ...
    func testUpdateTimestampStoresValue() {
        // given
        sut = CoreDataHistoryTimestampManager(target: "main-app", userDefaults: userDefaults)
        let date = Date()
    ...
    func testTimestampPersistsAcrossInstances() {
        // given
        let date = Date()
        let firstManager = CoreDataHistoryTimestampManager(target: "main-app", userDefaults: userDefaults)
        firstManager.update(to: date)
        
        // when
        let secondManager = CoreDataHistoryTimestampManager(target: "main-app", userDefaults: userDefaults)
