...
public extension LoggerProtocol {
    ...
    func assertionError(_ message: String, file: String = #file, function: String = #function, line: Int = #line) {
        assertionError(message: message, file: file, function: function, line: line)
    }
}
